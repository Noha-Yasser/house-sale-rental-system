    ...
    @endif
            ...
            <div class="col-md-9">
                <table class="table table-bordered">
                    ...
                    <tr><th>Website</th><td>@if($companies->website) <a href="{{ $companies->website }}" target="_blank">{{ $companies->website }}</a> @else  @endif</td></tr>
                    <tr><th>Rating</th><td>{{ $companies->rating > 0 ? $companies->rating . ' ★' : 'Not rated' }}</td></tr>
