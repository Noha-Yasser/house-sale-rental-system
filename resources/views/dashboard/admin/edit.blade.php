...
@endif value="{{ city->id ?? "" }}" >{{ $city->name ?? "" }} </option>--}}
               ...
               <div class="row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="file" class="form-control" id="image" placeholder="choose Image" name="image"  value="{{ $admins->user->image ?? ""}}" required>
                  </div>
                   ...
                   <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="adderss" placeholder="Enter adderss" name="adderss" value="{{ $admins->user->adderss ?? "" }}" required>
                  </div>
                </div>
